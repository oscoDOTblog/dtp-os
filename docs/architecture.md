...
| Click toolbar icon | `popup.html` + `js/popup.js` | Tool launcher or last-used tool (e.g. Emojis picker) |
...
4. Click the **toolbar icon** and confirm the popup opens (tool list on first visit; Emojis picker after first use).
